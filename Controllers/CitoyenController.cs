...
public async Task<IActionResult> Delete(int id)
{
    ...
    var voteLogs = _db.VoteLogs.Where(v => v.CitoyenId == id);
    _db.VoteLogs.RemoveRange(voteLogs);

   
    var votes = _db.Votes.Where(v => v.CitoyenId == id || v.CitoyenId == citoyen.UtilisateurId);
    _db.Votes.RemoveRange(votes);

   
    var cinRequests = _db.CinRequests.Where(c => c.CitoyenId == id);
